...
from post_selection_tool.direct_dcr_repair_v13 import apply_direct_dcr_repair_v13
...
def test_direct_dcr_repair_v13_limited_generic_fill_reaches_target() -> None:
    ...
    _, final_records, report = apply_direct_dcr_repair_v13(
    ...
    assert report["version"] == "direct_dcr_repair_v13"
