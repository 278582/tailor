...
from post_selection_tool.direct_dcr_repair_v9 import apply_direct_dcr_repair_v9
...
def test_direct_dcr_repair_v9_uses_surrogate_biased_candidate_pool() -> None:
    ...
    _, final_records, report = apply_direct_dcr_repair_v9(
    ...
    assert report["version"] == "direct_dcr_repair_v9"
