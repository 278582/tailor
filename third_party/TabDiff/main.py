...
if __name__ == '__main__':
    ...
    parser.add_argument('--sample_only', action='store_true', help='Only sample synthetic tables and save samples.csv without evaluation')
    parser.add_argument('--train_steps', type=int, default=None, help='Override training steps for fast smoke runs')
    parser.add_argument('--check_val_every', type=int, default=None, help='Override validation frequency')
    parser.add_argument('--train_batch_size', type=int, default=None, help='Override training batch size')
    parser.add_argument('--sample_batch_size', type=int, default=None, help='Override sampling batch size')
    parser.add_argument('--num_timesteps', type=int, default=None, help='Override diffusion timesteps')
