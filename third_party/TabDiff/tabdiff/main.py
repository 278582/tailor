...
def main(args):
    ...
    if args.mode == 'train':
        ...
        if ckpt_path is None:
            ...
            if not ckpt_path_arr:
                ckpt_path_arr = glob.glob(f"{ckpt_parent_path}/model_*.pt")
            if not ckpt_path_arr:
                ckpt_path_arr = glob.glob(f"{ckpt_parent_path}/ema_model_*.pt")
    ...
    if args.train_steps is not None:
        raw_config['train']['main']['steps'] = args.train_steps
    if args.check_val_every is not None:
        raw_config['train']['main']['check_val_every'] = args.check_val_every
    if args.train_batch_size is not None:
        raw_config['train']['main']['batch_size'] = args.train_batch_size
    if args.sample_batch_size is not None:
        raw_config['sample']['batch_size'] = args.sample_batch_size
